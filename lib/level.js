...
class Level {
  ...
  levelSelector(level) {
    if (level === 1 || !level) { return this.levelOne(); }
    if (level === 2) { return this.levelTwo(); }
    if (level === 3) { return this.levelThree(); }
    if (level === 4) { return this.levelFour(); }
    if (level === 5) { return this.levelFive(); }
  }
