...
export default class Game {
  ...
  livesTracker(){
    console.log("this.currentLives = " + this.lives);
    document.querySelector('#lives-galada').innerHTML = "Lives: " + this.lives;
    // $('#lives-galada').innerHTML = "Lives: " + this.lives;
  }
  ...
  scoreBoard(){
    this.scoreTracker();
    // document.querySelector('#clicks-galada').innerHTML = this.clicks;
    // $('#clicks-galada').innerHTML = "Score: " + this.clicks;
    this.levelTracker();
    this.livesTracker();
  }
  ...
  start(levelData=null){
    ...
    document.querySelector('#ra-pony').src = this.levelData.levelPictures;
